...
class CommentTestCase(APITestCase):
    def setUp(self) -> None:
        ...
        self.response = self.client.post(
            self.url, data=data, format="json", HTTP_AUTHORIZATION=self.token
        )
    ...
    def test_update_comment(self):
        data = {"comment": "hello, edite comment form TestCase.!"}
...
class ReplayTestCase(APITestCase):
    def setUp(self) -> None:
        ...
        self.reply_response = self.client.post(
    ...
    def test_update(self):
        data = {"reply": "this is edite to reply made from TestCase"}
