...
tags_list = ['python', 'djagno', 'javaScript', 'C', 'C++', 'C#', 'Haskl',
             'Pascal', 'Rust', 'Rube', 'Go', 'Scala']


def create_user():
    for i in range(16000, 1000000):
        data = {
        ...
        for post in range(10):
            post_data = {
                ...
                "create_data": "2022-02-20T04:40:04.428433Z",
                "update": "2022-02-20T04:40:02Z",
                "user_id": user.pk
            }
