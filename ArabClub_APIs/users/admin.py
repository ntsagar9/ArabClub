...
from users.models import (
    User, FirstNameAndLastName, Phone, Skills, Address, Bio, GitHubAccount
)
...
class UserChangeForm(forms.ModelForm):
    ...
    class Meta:
        model = User
        fields = ('email', 'password', 'username', 'date_of_birth', 'is_active',
                  'is_admin')
...
class UserAdmin(BaseUserAdmin):
    ...
    inlines = [
        UserAddNamesForm, UserPhone, UserBio, UserAddress, UserSkills,
        UserGitHub
    ]
    ...
    add_fieldsets = (
        (None, {
            'classes': ('wide',),
            'fields': ('email', 'username', 'date_of_birth', 'password1',
                       'password2'),
        }),
    )
